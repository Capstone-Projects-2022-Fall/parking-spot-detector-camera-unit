...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/pi/parking-spot-detector-camera-unit/camera-unit'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/pi/parking-spot-detector-camera-unit/camera-unit/bin/deactivate.nu'
